    ...
    public View initView(){
        ...
        gridView.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                textView.setText(position+"fffffffffffffffffffffffffffffffffffffffff");
                TextView textViewf=(TextView)view.findViewById(R.id.vi_from);
                textViewf.setText(position+"aaaaaaaa");
                return view;
            }
        });
